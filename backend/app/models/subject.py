...
class Subject(Base):
    ...
    # Classification
    category = Column(String(100), nullable=True)  # science, arts, commerce, engineering, medical
    ...
    prerequisite = relationship("Subject", remote_side="Subject.id", backref="required_for")
