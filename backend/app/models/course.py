...
class CourseType(Base):
    ...
    category = Column(
        String(50)
    )  # secondary, undergraduate, graduate, diploma, certificate
...
class Course(Base):
    ...
    )  # optional: course catalog is standalone; offerings via institution_courses
    ...
    institution_offerings = relationship(
        "InstitutionCourse", back_populates="course", cascade="all, delete-orphan"
    )
