...
import { BellIcon } from '@shikkhahub/shared/src/components/icons';
import {
  SOURCE_FEED_QUERY,
  supportedTypesForPrivateSources,
} from '@shikkhahub/shared/src/graphql/feed';
import { useAuthContext } from '@shikkhahub/shared/src/contexts/AuthContext';
import { SquadPageHeader } from '@shikkhahub/shared/src/components/squads/SquadPageHeader';
import SquadFeedHeading from '@shikkhahub/shared/src/components/squads/SquadFeedHeading';
import {
  BaseFeedPage,
  FeedPageLayoutList,
} from '@shikkhahub/shared/src/components/utilities';
import Link from '@shikkhahub/shared/src/components/utilities/Link';
import type { SquadStaticData } from '@shikkhahub/shared/src/graphql/squads';
import {
  getSquadMembers,
  getSquad,
  getSquadStaticFields,
} from '@shikkhahub/shared/src/graphql/squads';
import type {
  BasicSourceMember,
  SourceData,
  Squad,
} from '@shikkhahub/shared/src/graphql/sources';
import {
  isSourceUserSource,
  SOURCE_QUERY,
  SourceType,
...
import { OtherFeedPage, StaleTime } from '@shikkhahub/shared/src/lib/query';
...
import { GET_REFERRING_USER_QUERY } from '@shikkhahub/shared/src/graphql/users';
import type {
  PublicProfile,
  UserShortProfile,
...
} from '@shikkhahub/shared/src/hooks/useToastNotification';
...
const SquadEmptyScreen = dynamic(
  () =>
    import(
      /* webpackChunkName: "squadEmptyScreen" */ '@shikkhahub/shared/src/components/squads/SquadEmptyScreen'
    ),
);
...
const SquadLoading = dynamic(
  () =>
    import(
      /* webpackChunkName: "squadLoading" */ '@shikkhahub/shared/src/components/errors/SquadLoading'
    ),
  { ssr: false },
);
