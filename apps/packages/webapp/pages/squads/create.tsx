...
import {
  ...
  WritePageContainer,
} from '@shikkhahub/shared/src/components/post/freeform';
...
import { useDiscardPost } from '@shikkhahub/shared/src/hooks/input/useDiscardPost';
import { WritePostContextProvider } from '@shikkhahub/shared/src/contexts';
import TabContainer, {
  Tab,
} from '@shikkhahub/shared/src/components/tabs/TabContainer';
import { ShareLink } from '@shikkhahub/shared/src/components/post/write/ShareLink';
import {
  generateDefaultSquad,
  MultipleSourceSelect,
} from '@shikkhahub/shared/src/components/post/write';
import Unauthorized from '@shikkhahub/shared/src/components/errors/Unauthorized';
import { verifyPermission } from '@shikkhahub/shared/src/graphql/squads';
import { SourcePermissions } from '@shikkhahub/shared/src/graphql/sources';
import {
  useActions,
...
} from '@shikkhahub/shared/src/components/fields/form/common';
import { useQueryClient } from '@tanstack/react-query';
import CreatePoll from '@shikkhahub/shared/src/components/post/poll/CreatePoll';
import { CreateLiveRoomForm } from '@shikkhahub/shared/src/components/liveRooms/CreateLiveRoomForm';
import { featureStandupCreation } from '@shikkhahub/shared/src/lib/featureManagement';
import { Pill, PillSize } from '@shikkhahub/shared/src/components/Pill';
import { useMultipleSourcePost } from '@shikkhahub/shared/src/features/squads/hooks/useMultipleSourcePost';
import { settingsUrl, webappUrl } from '@shikkhahub/shared/src/lib/constants';
import type { WriteForm } from '@shikkhahub/shared/src/contexts';
...
import { SettingsIcon } from '@shikkhahub/shared/src/components/icons';
import { LinkWithTooltip } from '@shikkhahub/shared/src/components/tooltips/LinkWithTooltip';
