...
import NotificationToggleIcon from '@shikkhahub/shared/src/components/icons/NotificationToggle/primary.svg';
import classed from '@shikkhahub/shared/src/lib/classed';
import { postWindowMessage, isPWA } from '@shikkhahub/shared/src/lib/func';
import { ENABLE_NOTIFICATION_WINDOW_KEY } from '@shikkhahub/shared/src/hooks/useNotificationPermissionPopup';
import { useRouter } from 'next/router';
import type { NotificationPromptSource } from '@shikkhahub/shared/src/lib/log';
...
import { usePushNotificationMutation } from '@shikkhahub/shared/src/hooks/notifications';
import dynamic from 'next/dynamic';
import { isChrome } from '@shikkhahub/shared/src/lib/constants';

const BrowserPermissionIcon: ComponentType<{ className?: string }> = dynamic(
  () =>
    import(
      /* webpackChunkName: "browserPermissionIcon" */ '@shikkhahub/shared/src/components/icons/BrowserPermission/primary.svg'
    ),
);
const ChromePermissionIcon: ComponentType<{ className?: string }> = dynamic(
  () =>
    import(
      /* webpackChunkName: "browserPermissionIcon" */ '@shikkhahub/shared/src/components/icons/BrowserPermission/chrome.svg'
    ),
);
