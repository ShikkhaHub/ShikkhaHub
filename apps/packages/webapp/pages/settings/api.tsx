...
} from '@shikkhahub/shared/src/hooks/api/usePersonalAccessTokens';
...
import { ModalSize } from '@shikkhahub/shared/src/components/modals/common/types';
import { ModalHeader } from '@shikkhahub/shared/src/components/modals/common/ModalHeader';
import { ModalBody } from '@shikkhahub/shared/src/components/modals/common/ModalBody';
import { ModalFooter } from '@shikkhahub/shared/src/components/modals/common/ModalFooter';
...
const CLAUDE_INSTALL_COMMAND = [
  `claude plugin marketplace add https://github.com/shikkhahub/daily.git`,
...
const CURSOR_REPO_URL = 'https://github.com/shikkhahub/daily.git';
