...
import { SubscriptionProvider } from '@shikkhahub/shared/src/lib/plus';
...
import {
  ...
  PlusType,
} from '@shikkhahub/shared/src/components/plus/PlusInfo';
...
const UpgradeToPlus = dynamic(() =>
  import(
    /* webpackChunkName: "upgradeToPlus" */ '@shikkhahub/shared/src/components/UpgradeToPlus'
  ).then((mod) => mod.UpgradeToPlus),
);

const PlusList = dynamic(() =>
  import(
    /* webpackChunkName: "plusList" */ '@shikkhahub/shared/src/components/plus/PlusList'
