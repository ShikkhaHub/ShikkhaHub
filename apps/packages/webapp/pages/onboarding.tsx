...
import { ExperimentWinner } from '@shikkhahub/shared/src/lib/featureValues';
import { storageWrapper as storage } from '@shikkhahub/shared/src/lib/storageWrapper';
import { useRouter } from 'next/router';
import { useAuthContext } from '@shikkhahub/shared/src/contexts/AuthContext';
import type { NextSeoProps } from 'next-seo';
import { SIGNIN_METHOD_KEY } from '@shikkhahub/shared/src/hooks/auth/useSignBack';
import {
  FooterLinks,
  withFeaturesBoundary,
} from '@shikkhahub/shared/src/components';
...
import type {
  AuthOptionsProps,
  AuthProps,
} from '@shikkhahub/shared/src/components/auth/common';
import {
  actionToAuthDisplay,
  OnboardingActions,
  AuthDisplay,
...
import {
  ...
  getFunnelBootData,
} from '@shikkhahub/shared/src/features/onboarding/funnelBoot';
import { BootApp } from '@shikkhahub/shared/src/lib/boot';
import { GdprConsentKey } from '@shikkhahub/shared/src/hooks/useCookieBanner';
import {
  ONBOARDING_BOOT_QUERY_KEY,
  useOnboardingBoot,
} from '@shikkhahub/shared/src/features/onboarding/hooks/useOnboardingBoot';
import {
  getCookiesAndHeadersFromRequest,
  redirectToApp,
  setResponseHeaderFromBoot,
} from '@shikkhahub/shared/src/features/onboarding/lib/utils';
import { Provider as JotaiProvider, useAtom } from 'jotai/react';

import { authAtom } from '@shikkhahub/shared/src/features/onboarding/store/onboarding.store';
import { OnboardingHeader } from '@shikkhahub/shared/src/components/onboarding';
import { FunnelStepper } from '@shikkhahub/shared/src/features/onboarding/shared/FunnelStepper';
...
import { isLocalhost } from '@shikkhahub/shared/src/lib/config';
