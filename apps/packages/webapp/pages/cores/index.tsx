...
} from '@shikkhahub/shared/src/contexts/BuyCoresContext/BuyCoresContext';
import { useRouter } from 'next/router';
import { useViewSizeClient, ViewSize } from '@shikkhahub/shared/src/hooks';

import { CoreFAQ } from '@shikkhahub/shared/src/components/cores/CoreFAQ';
import { Origin } from '@shikkhahub/shared/src/lib/log';
import type { CoreOptionsProps } from '@shikkhahub/shared/src/components/modals/award/BuyCoresModal';
import {
  BuyCoresCheckout,
  CoreOptions,
  CorePageCheckoutVideo,
  TransactionStatusListener,
} from '@shikkhahub/shared/src/components/modals/award/BuyCoresModal';
...
import { CoreIcon } from '@shikkhahub/shared/src/components/icons';
import { IconSize } from '@shikkhahub/shared/src/components/Icon';
import { buyCoreStarField } from '@shikkhahub/shared/src/lib/image';
import { useBuyCoresContext } from '@shikkhahub/shared/src/contexts/BuyCoresContext/types';
import { iOSSupportsCoresPurchase } from '@shikkhahub/shared/src/lib/ios';
