...
import { LiveRoom } from '@shikkhahub/shared/src/components/liveRooms/LiveRoom';
...
import {
  ...
  type LiveRoomData,
} from '@shikkhahub/shared/src/graphql/liveRooms';
import { getPlainTextFromRichContent } from '@shikkhahub/shared/src/lib/strings';
import {
  RequestKey,
  StaleTime,
  generateQueryKey,
