...
import type { GiftUserContextData } from '@shikkhahub/shared/src/components/plus/GiftUserContext';
import { GiftUserContext } from '@shikkhahub/shared/src/components/plus/GiftUserContext';
import type { CommonPlusPageProps } from '@shikkhahub/shared/src/components/plus/common';
import { isIOSNative } from '@shikkhahub/shared/src/lib/func';
...
const PlusMobile = dynamic(() =>
  import(
    /* webpackChunkName: "plusMobile" */ '@shikkhahub/shared/src/components/plus/PlusMobile'
  ).then((mod) => mod.PlusMobile),
);

const PlusDesktop = dynamic(() =>
  import(
    /* webpackChunkName: "plusDesktop" */ '@shikkhahub/shared/src/components/plus/PlusDesktop'
  ).then((mod) => mod.PlusDesktop),
);

const PlusIOS = dynamic(() =>
  import(
    /* webpackChunkName: "plusIOS" */ '@shikkhahub/shared/src/components/plus/PlusIOS'
