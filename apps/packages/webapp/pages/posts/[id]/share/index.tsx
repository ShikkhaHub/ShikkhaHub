...
import { POST_BY_ID_STATIC_FIELDS_QUERY } from '@shikkhahub/shared/src/graphql/posts';
import { ApiError, gqlClient } from '@shikkhahub/shared/src/graphql/common';
import type { TopCommentsData } from '@shikkhahub/shared/src/graphql/comments';
...
import { USER_SHORT_BY_ID } from '@shikkhahub/shared/src/graphql/users';
