...
import EmailCodeVerification from '@shikkhahub/shared/src/components/auth/EmailCodeVerification';
import { useRouter } from 'next/router';
import AuthHeader from '@shikkhahub/shared/src/components/auth/AuthHeader';
import HeaderLogo from '@shikkhahub/shared/src/components/layout/HeaderLogo';
import { AuthDataProvider } from '@shikkhahub/shared/src/contexts/AuthDataContext';
import { AuthModalText } from '@shikkhahub/shared/src/components/auth/common';
import {
  betterAuthSendVerificationOTP,
  betterAuthVerifyEmailOTP,
} from '@shikkhahub/shared/src/lib/betterAuth';
import {
  Button,
  ButtonVariant,
