import type { TopReader } from '@shikkhahub/shared/src/components/badges/TopReaderBadge';
import type { UserProductSummary } from '@shikkhahub/shared/src/graphql/njord';
import type {
  QuestBucket,
  QuestDashboard,
  UserQuest,
} from '@shikkhahub/shared/src/graphql/quests';
import { QuestStatus } from '@shikkhahub/shared/src/graphql/quests';
import type { UserAchievement } from '@shikkhahub/shared/src/graphql/user/achievements';
