...
} from '@shikkhahub/shared/src/graphql/keywords';
import { useInfiniteQuery, useMutation } from '@tanstack/react-query';
import type { FeedData } from '@shikkhahub/shared/src/graphql/feed';
import { KEYWORD_FEED_QUERY } from '@shikkhahub/shared/src/graphql/feed';
import { NextSeo } from 'next-seo';
import ActivitySection from '@shikkhahub/shared/src/components/profile/ActivitySection';
import { smallPostImage } from '@shikkhahub/shared/src/lib/image';
import {
  Button,
  ButtonColor,
  ButtonVariant,
...
import { ResponsivePageContainer } from '@shikkhahub/shared/src/components/utilities';
import dynamic from 'next/dynamic';
import ProgressiveEnhancementContext from '@shikkhahub/shared/src/contexts/ProgressiveEnhancementContext';
...
const KeywordSynonymModal = dynamic(
  () =>
    import(
      /* webpackChunkName: "keywordSynonymModal" */ '@shikkhahub/shared/src/components/modals/KeywordSynonymModal'
    ),
);
