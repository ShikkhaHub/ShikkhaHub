...
import { downloadBrowserExtension } from '@shikkhahub/shared/src/lib/constants';
import { FlexCentered } from '@shikkhahub/shared/src/components/utilities';
import BrowsersIcon from '@shikkhahub/shared/icons/browsers.svg';
    ...
    >
      ...
      <div className="z-1 mt-20 flex w-full flex-col p-4 laptop:ml-3 laptop:mt-0 laptop:max-w-[25rem] laptop:p-0 laptopL:ml-[9.25rem] laptopL:max-w-[37.25rem]">
        ...
        <Button
          ...
          // important has been used is some classnames to override the default styles as agreed on [thread](https://shikkhahub.slack.com/archives/C05P9ET7S9K/p1699023366663489?thread_ts=1699011522.350609&cid=C05P9ET7S9K)
