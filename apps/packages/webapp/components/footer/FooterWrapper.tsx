...
const NewComment = dynamic(() =>
  import(
    /* webpackChunkName: "newComment" */ '@shikkhahub/shared/src/components/post/NewComment'
  ).then((mod) => mod.NewComment),
);

const MobilePostFloatingBar = dynamic(() =>
  import(
    /* webpackChunkName: "mobilePostFloatingBar" */ '@shikkhahub/shared/src/components/post/MobilePostFloatingBar'
...
const CommentInputOrModal = dynamic(
  () =>
    import(
      /* webpackChunkName: "commentInputOrModal" */ '@shikkhahub/shared/src/components/comments/CommentInputOrModal'
    ),
);
