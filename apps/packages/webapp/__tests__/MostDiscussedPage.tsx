...
import { MOST_DISCUSSED_FEED_QUERY } from '@shikkhahub/shared/src/graphql/feed';
...
import type { CommentFeedData } from '@shikkhahub/shared/src/graphql/comments';
import { COMMENT_FEED_QUERY } from '@shikkhahub/shared/src/graphql/comments';
