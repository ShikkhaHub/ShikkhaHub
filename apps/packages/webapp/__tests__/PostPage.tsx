...
import type { PostCommentsData } from '@shikkhahub/shared/src/graphql/comments';
import { POST_COMMENTS_QUERY } from '@shikkhahub/shared/src/graphql/comments';
import type { Action } from '@shikkhahub/shared/src/graphql/actions';
import {
  ActionType,
  COMPLETE_ACTION_MUTATION,
  COMPLETED_USER_ACTIONS,
} from '@shikkhahub/shared/src/graphql/actions';
...
import {
  completeActionMock,
  mockGraphQL,
} from '@shikkhahub/shared/__tests__/helpers/graphql';
import { SourceType } from '@shikkhahub/shared/src/graphql/sources';
import { createTestSettings } from '@shikkhahub/shared/__tests__/fixture/settings';
import type { AllTagCategoriesData } from '@shikkhahub/shared/src/graphql/feedSettings';
import {
  ADD_FILTERS_TO_FEED_MUTATION,
  FEED_SETTINGS_QUERY,
  REMOVE_FILTERS_FROM_FEED_MUTATION,
} from '@shikkhahub/shared/src/graphql/feedSettings';
import { TestBootProvider } from '@shikkhahub/shared/__tests__/helpers/boot';
import * as hooks from '@shikkhahub/shared/src/hooks/useViewSize';
import { UserVoteEntity } from '@shikkhahub/shared/src/hooks';
import { getLogContextStatic } from '@shikkhahub/shared/src/contexts/LogContext';
...
//
// jest.mock('@shikkhahub/shared/src/hooks/useSubscription', () => ({
//   __esModule: true,
//   default: jest
//     .fn()
//     .mockImplementation(
