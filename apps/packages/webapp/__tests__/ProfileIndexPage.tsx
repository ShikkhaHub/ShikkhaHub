...
import { USER_READING_HISTORY_QUERY } from '@shikkhahub/shared/src/graphql/users';
...
const defaultProfile: PublicProfile = {
  ...
  socialLinks: [
    ...
    { platform: 'hashnode', url: 'https://hashnode.com/@shikkhahub' },
...
it('should show social links in about me section', async () => {
  ...
  expect(twitterLinks[0]).toHaveAttribute('href', 'https://x.com/shikkhahub');
