...
jest.mock('@shikkhahub/shared/src/graphql/user/profile', () => ({
  ...jest.requireActual('@shikkhahub/shared/src/graphql/user/profile'),
  getUserExperienceById: jest.fn(),
}));

jest.mock('@shikkhahub/shared/src/features/onboarding/lib/utils', () => ({
