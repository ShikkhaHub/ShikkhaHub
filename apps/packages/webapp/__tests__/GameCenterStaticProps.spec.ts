...
import { QuestStatus, QuestType } from '@shikkhahub/shared/src/graphql/quests';
import GameCenterPage, {
  getStaticProps as getGameCenterStaticProps,
} from '../pages/game-center/index';

jest.mock('@shikkhahub/shared/src/graphql/common', () => {
  const actual = jest.requireActual('@shikkhahub/shared/src/graphql/common');
...
jest.mock('@shikkhahub/shared/src/contexts/AuthContext', () => {
  const actual = jest.requireActual(
    '@shikkhahub/shared/src/contexts/AuthContext',
  );
...
jest.mock('@shikkhahub/shared/src/contexts/SettingsContext', () => {
  const actual = jest.requireActual(
    '@shikkhahub/shared/src/contexts/SettingsContext',
  );
...
jest.mock(
  '@shikkhahub/shared/src/hooks/profile/useProfileAchievements',
  () => ({
...
jest.mock(
  '@shikkhahub/shared/src/hooks/profile/useTrackedAchievement',
  () => ({
    useTrackedAchievement: jest.fn(),
  }),
);

jest.mock('@shikkhahub/shared/src/hooks/useClaimQuestReward', () => ({
  useClaimQuestReward: jest.fn(),
}));

jest.mock('@shikkhahub/shared/src/hooks/useConditionalFeature', () => ({
  useConditionalFeature: jest.fn(),
}));

jest.mock('@shikkhahub/shared/src/hooks/useCoresFeature', () => ({
  useHasAccessToCores: jest.fn(),
}));

jest.mock('@shikkhahub/shared/src/hooks/useQuestDashboard', () => ({
