...
} from '@shikkhahub/shared/src/features/onboarding/shared/DiscountTimer';
import { DISCOUNT_LOCAL_STORAGE_KEY } from '@shikkhahub/shared/src/features/onboarding/store/funnel.store';
import { ButtonSize, ButtonVariant } from '@shikkhahub/shared/src/components/buttons/common';
