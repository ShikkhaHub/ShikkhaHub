    ...
    return mergeConfig(config, {
      ...
      resolve: {
        alias: {
          ...
          '../../GrowthBookProvider': GrowthBookMockPath,
          '@shikkhahub/shared/src/lib/boot': path.resolve(
            __dirname,
            '../mock/boot.ts',
          ),
          ...
          '@shikkhahub/shared/src/hooks/useToastNotification': path.resolve(
            __dirname,
            '../mock/hooks/useToastNotification.ts',
          ),
          '@shikkhahub/shared/src/hooks/useActions': path.resolve(
            __dirname,
