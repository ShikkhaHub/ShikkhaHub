import * as actual from '@shikkhahub/shared/src/lib/boot';
import { Alerts } from '@shikkhahub/shared/src/graphql/alerts';
import { RemoteSettings } from '@shikkhahub/shared/src/graphql/settings';
...
export * from '@shikkhahub/shared/src/lib/boot';
