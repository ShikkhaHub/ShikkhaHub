...
import type { Boot, BootCacheData } from '@shikkhahub/shared/src/lib/boot';
import { BootApp, getBootData } from '@shikkhahub/shared/src/lib/boot';
import type { RemoteSettings } from '@shikkhahub/shared/src/graphql/settings';
import { UPDATE_USER_SETTINGS_MUTATION } from '@shikkhahub/shared/src/graphql/settings';
import type { Alerts } from '@shikkhahub/shared/src/graphql/alerts';
...
import * as actionHook from '@shikkhahub/shared/src/hooks/useActions';
import loggedUser from '@shikkhahub/shared/__tests__/fixture/loggedUser';
import * as libFuncs from '@shikkhahub/shared/src/lib/func';
import { SortCommentsBy } from '@shikkhahub/shared/src/graphql/comments';
...
jest.mock('@shikkhahub/shared/src/lib/boot', () => ({
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...(jest.requireActual('@shikkhahub/shared/src/lib/boot') as any),
  getBootData: jest.fn(),
}));
