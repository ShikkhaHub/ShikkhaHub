...
import MainFeedLayout from '@shikkhahub/shared/src/components/MainFeedLayout';
import ScrollToTopButton from '@shikkhahub/shared/src/components/ScrollToTopButton';
import { getShouldRedirect } from '@shikkhahub/shared/src/components/utilities';
...
import { useDndContext } from '@shikkhahub/shared/src/contexts/DndContext';
import { FeedLayoutProvider } from '@shikkhahub/shared/src/contexts/FeedContext';
import useCustomDefaultFeed from '@shikkhahub/shared/src/hooks/feed/useCustomDefaultFeed';
import {
  CustomizeNewTabProvider,
  useCustomizeNewTab,
} from '@shikkhahub/shared/src/features/customizeNewTab/CustomizeNewTabContext';
import { CustomizeNewTabSidebar } from '@shikkhahub/shared/src/features/customizeNewTab/CustomizeNewTabSidebar';
import { isFocusActiveAt } from '@shikkhahub/shared/src/features/customizeNewTab/lib/focusSchedule';
import { normaliseNewTabMode } from '@shikkhahub/shared/src/features/customizeNewTab/lib/newTabMode';
import { DndBanner } from '@shikkhahub/shared/src/components/DndBanner';
...
const PostsSearch = dynamic(
  () =>
    import(
      /* webpackChunkName: "postsSearch" */ '@shikkhahub/shared/src/components/PostsSearch'
    ),
);
