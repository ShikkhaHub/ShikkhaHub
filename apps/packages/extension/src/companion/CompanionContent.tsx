...
import { CopyIcon } from '@shikkhahub/shared/src/components/icons';
import {
  HotLabel,
  TLDRText,
...
import { useUpvoteQuery } from '@shikkhahub/shared/src/hooks/useUpvoteQuery';
import { postLogEvent } from '@shikkhahub/shared/src/lib/feed';
import { ShareProvider } from '@shikkhahub/shared/src/lib/share';
