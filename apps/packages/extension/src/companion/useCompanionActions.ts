...
import { ADD_FILTERS_TO_FEED_MUTATION } from '@shikkhahub/shared/src/graphql/feedSettings';
import { UPDATE_ALERTS } from '@shikkhahub/shared/src/graphql/alerts';
import { UPDATE_USER_SETTINGS_MUTATION } from '@shikkhahub/shared/src/graphql/settings';
import type { MutateFunc } from '@shikkhahub/shared/src/lib/query';
