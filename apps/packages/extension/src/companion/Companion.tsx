...
import { REQUEST_PROTOCOL_KEY } from '@shikkhahub/shared/src/graphql/common';
import '@shikkhahub/shared/src/styles/globals.css';
import type {
  AccessToken,
  PostBootData,
} from '@shikkhahub/shared/src/lib/boot';
...
import { usePopupSelector } from '@shikkhahub/shared/src/hooks/usePopupSelector';
