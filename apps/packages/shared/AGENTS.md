...
The shared package (`@shikkhahub/shared`) contains all code shared between the webapp and browser extension. This is the heart of the codebase.
...
import { useBookmarkPost } from '@shikkhahub/shared/src/hooks';
import { POST_BY_ID_QUERY } from '@shikkhahub/shared/src/graphql/posts';
```
