...
const faq = [
  ...
  },
  {
    ...
    description:
      'Post about your project on social media tagging @shikkhahub with a link to your live URL and a short summary. You can also post on daily.dev platform with keyword #hackathon. This post on social media or on daily.dev IS your submission.',
  },
  {
