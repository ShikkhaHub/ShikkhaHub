...
<p align="center">
  <a href="https://circleci.com/gh/shikkhahub/apps">
    <img src="https://img.shields.io/circleci/build/github/shikkhahub/apps/**master**.svg" alt="Build Status">
  </a>
  <a href="https://github.com/shikkhahub/apps/blob/master/LICENSE">
    <img src="https://img.shields.io/github/license/shikkhahub/apps.svg" alt="License">
  </a>
  <a href="https://stackshare.io/daily/daily">
    <img src="http://img.shields.io/badge/tech-stack-0690fa.svg?style=flat" alt="StackShare">
  </a>
  <a href="https://github.com/shikkhahub/apps/actions/workflows/e2e-tests.yml">
    <img src="https://github.com/shikkhahub/apps/actions/workflows/e2e-tests.yml/badge.svg?branch=main" alt="E2E Tests">
  </a>
</p>
...
### [packages](https://github.com/shikkhahub/apps/tree/main/packages)
...
- ### [eslint-config](https://github.com/shikkhahub/apps/tree/main/packages/eslint-config)

  Shared ESLint settings for maintaining consistent code quality across the project.

- ### [eslint-rules](https://github.com/shikkhahub/apps/tree/main/packages/eslint-rules)

  A custom ESLint plugin that defines a set of rules for the project, including a rule to enforce consistent color usage.

- ### [extension](https://github.com/shikkhahub/apps/tree/main/packages/extension)
...
- ### [prettier-config](https://github.com/shikkhahub/apps/tree/main/packages/prettier-config)

  Shared Prettier settings for all the projects in this repo.

- ### [shared](https://github.com/shikkhahub/apps/tree/main/packages/shared)
...
- ### [storybook](https://github.com/shikkhahub/apps/tree/main/packages/storybook)

  The Storybook configuration for the project, used to develop and showcase UI components in isolation.

- ### [webapp](https://github.com/shikkhahub/apps/tree/master/packages/webapp)

  The web app project. This is a Next.js project and has more pages than the extension, such as a registration page, post page, profile page, etc. For more information [click here](https://github.com/shikkhahub/apps/tree/master/packages/webapp).
...
[CONTRIBUTING.md](https://github.com/shikkhahub/.github/blob/master/CONTRIBUTING.md)
